...
public abstract class BaseViewSubCadastroDTO<P, T, I extends Serializable, B extends IBaseCrud<T, I>, 
L extends ViewConfig> extends BaseViewController implements Serializable {

	private static final long serialVersionUID = 1L;

	/** The pagina editar. */
	private Class<L> paginaEditar;
	 ...
	 *            the pagina editar
	 */
	public BaseViewSubCadastroDTO(Class<L> paginaEditar) {
		super();
