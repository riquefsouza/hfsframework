...
var DEFAULT_URL = decodeURIComponent(window.location.search.replace(/\?url=(.*)/, "$1"));
  ...
  open: function pdfViewOpen(file, scale, password,
    ...
    PDFJS.getDocument(parameters, pdfDataRangeTransport, passwordNeeded,
      ...
      function getDocumentCallback(pdfDocument) {
    	document.getElementById("aguardeDocumento").style.display = 'block';
        self.load(pdfDocument, scale);
        document.getElementById("aguardeDocumento").style.display = 'none';
