...
public class AdmAuditoriaRevisao implements Serializable {
	...
	/** The id. */
	@Id
	@GenericGenerator(name = "ADM_AUDITORIA_REVISAO_ID_GENERATOR", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", parameters = {
			@Parameter(name = "sequence_name", value = "ADM_AUDITORIA_REVISAO_SEQ"),
			@Parameter(name = "initial_value", value = "1"), @Parameter(name = "increment_size", value = "1") })
	@SequenceGenerator(name = "ADM_AUDITORIA_REVISAO_ID_GENERATOR")
