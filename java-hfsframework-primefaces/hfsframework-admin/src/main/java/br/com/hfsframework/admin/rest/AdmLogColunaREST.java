...
/**
 * The Class AdmLogColunaREST.
 */
@Path("admlogcoluna")
public class AdmLogColunaREST implements Serializable {
	...
	public AdmLogColuna load(@PathParam("id") String id) {
		return bc.load(id);
	}
	...
	@GET
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmLogColuna> findAll() {
		return bc.findAll();
	}
	...
	public AdmLogColuna insert(AdmLogColuna bean) throws TransacaoException {
	...
	@Path("{id}")
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public AdmLogColuna update(@PathParam("id") String id, AdmLogColuna bean) throws TransacaoException {
	...
	@DELETE
	@Path("{id}")
	public void delete(@PathParam("id") String id) throws TransacaoException {
	...
	@Path("{inicial}/{final}")
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmLogColuna> listarPorIntervalo(@PathParam("inicial") Integer intervaloInicial,
	...
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmLogColuna> listarPaginada(@PathParam("numpagina") Integer numeroPagina, 
