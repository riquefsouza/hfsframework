...
import br.com.hfsframework.admin.AdmSetorBC;
import br.com.hfsframework.admin.model.AdmSetor;
import br.com.hfsframework.util.exceptions.TransacaoException;

/**
 * The Class AdmSetorREST.
 */
@Path("admsetor")
public class AdmSetorREST implements Serializable {
	...
	public AdmSetor load(@PathParam("id") String id) {
		return bc.load(id);
	}
	...
	public AdmSetor insert(AdmSetor bean) throws TransacaoException {
	...
	@Path("{id}")
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public AdmSetor update(@PathParam("id") String id, AdmSetor bean) throws TransacaoException {
	...
	@Path("{inicial}/{final}")
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmSetor> listarPorIntervalo(@PathParam("inicial") Integer intervaloInicial,
	...
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmSetor> listarPaginada(@PathParam("numpagina") Integer numeroPagina, 
