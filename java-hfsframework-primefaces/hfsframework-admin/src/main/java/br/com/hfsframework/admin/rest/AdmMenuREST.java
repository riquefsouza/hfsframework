...
/**
 * The Class AdmMenuREST.
 */
@Path("admmenu")
public class AdmMenuREST implements Serializable {
	...
	public AdmMenu load(@PathParam("id") Long id) {
		return bc.load(id);
	}
	...
	public AdmMenu insert(AdmMenu bean) throws TransacaoException {
	...
	@Path("{id}")
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public AdmMenu update(@PathParam("id") Long id, AdmMenu bean) throws TransacaoException {
	...
	@Path("{inicial}/{final}")
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmMenu> listarPorIntervalo(@PathParam("inicial") Integer intervaloInicial,
	...
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmMenu> listarPaginada(@PathParam("numpagina") Integer numeroPagina, 
