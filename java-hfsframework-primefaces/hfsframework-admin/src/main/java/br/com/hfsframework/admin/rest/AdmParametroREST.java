...
/**
 * The Class AdmParametroREST.
 */
@Path("admparametro")
public class AdmParametroREST implements Serializable {
	...
	public AdmParametro load(@PathParam("id") Long id) {
		return bc.load(id);
	}
	...
	@GET
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmParametro> findAll() {
		return bc.findAll();
	}
	...
	public AdmParametro insert(AdmParametro bean) throws TransacaoException {
	...
	@Path("{id}")
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public AdmParametro update(@PathParam("id") Long id, AdmParametro bean) throws TransacaoException {
	...
	@Path("{inicial}/{final}")
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmParametro> listarPorIntervalo(@PathParam("inicial") Integer intervaloInicial,
	...
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<AdmParametro> listarPaginada(@PathParam("numpagina") Integer numeroPagina, 
