...
public class AdmPerfilRelMB 
	extends BaseViewRelatorio<AdmPerfil, Long, AdmPerfilBC>
	...
	/** The relatorio. */
	@Inject
	@RelatorioPath("AdmPerfil")
	private IBaseRelatorio relatorio;

	/**
	 * Instantiates a new adm perfil rel MB.
	 */
	public AdmPerfilRelMB() {
		super();
